...
public class HoverTest {
    ...
    public void test2() throws InterruptedException {
        ...
        for (int i = 1; i <= 3; i++) {          // selenium u 3 image arasinda dolandirmak icin loop yazdi

            String xpathImg = "(//img)["+i+"]";     // locater i String e koydu ve i her arttiginda locater 1 yükselecek. Thats how we have a "dynamic locator"
            ...
            String textXpath = "//h5[.='name: user"+i+"']";     //same logic. We create a dynamic locater.
